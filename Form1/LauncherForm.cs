...
namespace Form1
{
	public class LauncherForm : MetroForm
	{
		...
		private void InitializeComponent()
		{
            ...
            this.LauncherProcessList.CheckStateMember = null;
            ...
            this.LauncherMapList.Size = new System.Drawing.Size(204, 256);
            ...
            this.LauncherMapListFilterComboBox.Items.AddRange(new object[] {
            "All",
            "patch",
            "SP",
            "MP",
    ...
    "r\r\n}\r\n";
            ...
            this.LauncherRunGameButton.Location = new System.Drawing.Point(635, 249);
    ...
    "d\\b\\f0\\fs18\\par\r\n}\r\n";
		...
		private void LauncherMapList_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			EnableMapList();
			ReadMapAssetListFile(mapName);
			if (Launcher.selectedMapFilter == "only csv")
			{
				LauncherBuildFastFilesCheckBox.Enabled = false;
			...
			LauncherBuildFastFilesCheckBox.Enabled = true;
		...
		private void UpdateMapList()
		{
			...
			else if (Launcher.selectedMapFilter == "only csv")
			{
				var zoneSourList = Launcher.GetZoneSourceFiles().ToList();
				foreach (var map in allMap.ToList())
                {
