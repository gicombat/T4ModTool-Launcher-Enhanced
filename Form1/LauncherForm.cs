...
namespace Form1
{
	public class LauncherForm : MetroForm
	{
		...
		private System.Windows.Forms.TabPage LauncherTabCompileLevel;
		...
		private ComboBoxEx LauncherMapListFilterComboBox;
		...
		private void AddFilesToTreeView(string Directory, TreeNodeCollection tree, bool firstTime)
		{
			...
			{
				if (fileInfo.Extension.ToLower() != ".ff" && 
				    fileInfo.Extension.ToLower() != ".iwd" && 
				    fileInfo.Extension.ToLower() != ".files" && 
				    fileInfo.Extension.ToLower() != ".log" && 
				    fileInfo.Extension.ToLower() != ".bak" && 
				    fileInfo.Extension.ToLower() != ".txt" && 
				    fileInfo.Extension.ToLower() != ".rar" && 
				    fileInfo.Extension.ToLower() != ".bat" && 
				    fileInfo.Name.ToLower() != "mod.csv" && 
				    fileInfo.Name.ToLower() != "localized_french_mod.csv" && 
				    fileInfo.Name.ToLower() != "localized_english_mod.csv" && 
				    fileInfo.Name.ToLower() != "localized_german_mod.csv" && 
				    fileInfo.Name.ToLower() != "localized_italian_mod.csv" && 
				    fileInfo.Name.ToLower() != "localized_spanish_mod.csv" && 
				    fileInfo.Name.ToLower() != "localized_korean_mod.csv" && 
				    fileInfo.Name.ToLower() != "localized_polish_mod.csv" && 
				    fileInfo.Name.ToLower() != "localized_russian_mod.csv")
				{
		...
		private void InitializeComponent()
		{
			...
			this.LauncherMapListFilterComboBox = new DevComponents.DotNetBar.Controls.ComboBoxEx();
			...
			// 
			this.LauncherProcessGroupBox.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) | System.Windows.Forms.AnchorStyles.Left)));
			...
			// 
			this.LauncherProcessTextBox.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left) | System.Windows.Forms.AnchorStyles.Right)));
			...
			this.LauncherProcessTimeElapsedTextBox.Size = new System.Drawing.Size(69, 22);
			this.LauncherProcessTimeElapsedTextBox.TabIndex = 4;
			// 
			// LauncherTab
			// 
			this.LauncherTab.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) | System.Windows.Forms.AnchorStyles.Left) | System.Windows.Forms.AnchorStyles.Right)));
			...
			this.LauncherTabCompileLevel.Controls.Add(this.LauncherMapListFilterComboBox);
			...
			// 
			this.LauncherCompileLevelOptionsGroupBox.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) | System.Windows.Forms.AnchorStyles.Left) | System.Windows.Forms.AnchorStyles.Right)));
			...
			this.LauncherAssetCountGridView.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[] { this.AssetType, this.AssetCount, this.Percentage });
			...
			this.LauncherGridCollectDotsCheckBox.Size = new System.Drawing.Size(147, 20);
			...
			this.LauncherMapFFTypeGroupBox.Hide();
			// 
			// LauncherMapFFTypeMP
			// 
			...
			this.LauncherMapFFTypeMP.Size = new System.Drawing.Size(46, 20);
			...
			this.LauncherMapFFTypeSP.Size = new System.Drawing.Size(44, 20);
			...
			this.LauncherModSpecificMapCheckBox.Size = new System.Drawing.Size(135, 20);
			...
			this.LauncherRunMapAfterCompileCheckBox.Size = new System.Drawing.Size(164, 20);
			...
			this.LauncherBspInfoCheckBox.Size = new System.Drawing.Size(78, 20);
			...
			this.LauncherBuildFastFilesCheckBox.Size = new System.Drawing.Size(108, 20);
			...
			this.LauncherCompileReflectionsCheckBox.Size = new System.Drawing.Size(147, 20);
			...
			this.LauncherConnectPathsCheckBox.Size = new System.Drawing.Size(113, 20);
			...
			this.LauncherCompileVisCheckBox.Size = new System.Drawing.Size(99, 20);
			...
			this.LauncherCompileLightsCheckBox.Size = new System.Drawing.Size(115, 20);
			...
			this.LauncherCompileBSPCheckBox.Size = new System.Drawing.Size(107, 20);
			...
			// LauncherMapList
			// 
			this.LauncherMapList.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) | System.Windows.Forms.AnchorStyles.Left)));
			...
			this.LauncherMapList.Location = new System.Drawing.Point(6, 35);
			this.LauncherMapList.Name = "LauncherMapList";
			this.LauncherMapList.Size = new System.Drawing.Size(204, 253);
			...
			// 
			// LauncherMapListFilterComboBox
			// 
			this.LauncherMapListFilterComboBox.DisplayMember = "Text";
			this.LauncherMapListFilterComboBox.DrawMode = System.Windows.Forms.DrawMode.OwnerDrawFixed;
			this.LauncherMapListFilterComboBox.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.LauncherMapListFilterComboBox.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
			this.LauncherMapListFilterComboBox.FormattingEnabled = true;
			this.LauncherMapListFilterComboBox.ItemHeight = 14;
			...
			this.LauncherMapListFilterComboBox.Style = DevComponents.DotNetBar.eDotNetBarStyle.StyleManagerControlled;
			this.LauncherMapListFilterComboBox.TabIndex = 24;
			this.LauncherMapListFilterComboBox.SelectedValue = "All";
			this.LauncherMapListFilterComboBox.Items.AddRange(new object[] { "All", "patch", "SP", "MP", "nazi_zombie" });
			this.LauncherMapListFilterComboBox.SelectedIndexChanged += new System.EventHandler(this.LauncherMapListFilterComboBox_SelectedIndexChanged);
			// 
			...
			// 
			this.LauncherIwdFileGroupBox.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) | System.Windows.Forms.AnchorStyles.Left) | System.Windows.Forms.AnchorStyles.Right)));
			...
			this.LauncherIwdFileGroupBox.Size = new System.Drawing.Size(259, 335);
			...
			// LauncherIwdFileTree
			// 
			this.LauncherIwdFileTree.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) | System.Windows.Forms.AnchorStyles.Left) | System.Windows.Forms.AnchorStyles.Right)));
			...
			this.LauncherIwdFileTree.Size = new System.Drawing.Size(250, 308);
			...
			// 
			this.LauncherLocalizedCsvGroupBox.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) | System.Windows.Forms.AnchorStyles.Left)));
			...
			this.LauncherLocalizedCsvGroupBox.Size = new System.Drawing.Size(210, 341);
			...
			this.LauncherModLanguageComboBox.Items.AddRange(new object[] { "english", "french", "german", "italian", "spanish", "russian", "korean", "polish" });
			...
			this.LauncherModBuildSoundsCheckBox.Size = new System.Drawing.Size(106, 20);
			...
			this.LauncherModVerboseCheckBox.Size = new System.Drawing.Size(79, 20);
			...
			this.LauncherModBuildIwdFileCheckBox.Size = new System.Drawing.Size(111, 20);
			...
			this.LauncherModBuildFastFilesCheckBox.Size = new System.Drawing.Size(147, 20);
			...
			// 
			this.LauncherGameOptionsPanel.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) | System.Windows.Forms.AnchorStyles.Left) | System.Windows.Forms.AnchorStyles.Right)));
			...
			// 
			this.LauncherRunGameCustomCommandLineGroupBox.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left) | System.Windows.Forms.AnchorStyles.Right)));
			...
			// 
			this.LauncherRunGameCustomCommandLineTextBox.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) | System.Windows.Forms.AnchorStyles.Left) | System.Windows.Forms.AnchorStyles.Right)));
			...
			// 
			this.LauncherRunGameCommandLineGroupBox.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left) | System.Windows.Forms.AnchorStyles.Right)));
			...
			// 
			this.LauncherRunGameModGroupBox.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) | System.Windows.Forms.AnchorStyles.Right)));
			...
			this.LauncherRunGameExeTypeMpRadioButton.Size = new System.Drawing.Size(46, 20);
			...
			this.LauncherRunGameTypeRadioButton.Size = new System.Drawing.Size(44, 20);
			...
			this.LauncherTabExplore.Location = new System.Drawing.Point(4, 25);
			this.LauncherTabExplore.Name = "LauncherTabExplore";
			this.LauncherTabExplore.Padding = new System.Windows.Forms.Padding(3);
			this.LauncherTabExplore.Size = new System.Drawing.Size(763, 347);
			this.LauncherTabExplore.TabIndex = 0;
			this.LauncherTabExplore.Text = "Explore";
			// 
			// LauncherExploreGroupBox
			// 
			this.LauncherExploreGroupBox.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) | System.Windows.Forms.AnchorStyles.Left) | System.Windows.Forms.AnchorStyles.Right)));
			...
			this.LauncherExploreGroupBox.Size = new System.Drawing.Size(734, 358);
			...
			// 
			this.LauncherApplicationsGroupBox.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) | System.Windows.Forms.AnchorStyles.Left)));
			...
			// LauncherSplitter
			// 
			this.LauncherSplitter.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) | System.Windows.Forms.AnchorStyles.Left) | System.Windows.Forms.AnchorStyles.Right)));
			...
			this.LauncherConsole.Rtf = "{\\rtf1\\ansi\\ansicpg1252\\deff0\\nouicompat\\deflang1036{\\fonttbl{\\f0\\fnil\\fcharset0 " + "Microsoft Sans Serif;}}\r\n{\\*\\generator Riched20 10.0.22621}\\viewkind4\\uc1 \r\n\\par" + "d\\b\\f0\\fs18\\par\r\n}\r\n";
			...
			this.LauncherConsole.ZoomFactor = 0.931F;
			// 
			// LauncherForm
			// 
		...
		private void LauncherMapListFilterComboBox_SelectedIndexChanged(object sender, EventArgs e)
		{
			if (LauncherMapListFilterComboBox.SelectedItem != null)
			{
				Launcher.selectedMapFilter = LauncherMapListFilterComboBox.SelectedItem.ToString();
				UpdateMapList();
			}
		}
		...
		private void UpdateMapList()
		{
			...
			string[] allMap = Launcher.GetMapList();
			string[] filteredMap = new []{"Empty"};
			if (Launcher.selectedMapFilter == "patch")
			{
				filteredMap = allMap.ToList().FindAll(x => x.Contains("_patch")).ToArray();
			}
			else if (Launcher.selectedMapFilter == "SP")
			{
				var list = allMap.ToList();
				list.RemoveAll(x => x.EndsWith("_patch") || x.StartsWith("mp_") || x.StartsWith("nazi_zombie_") || x.EndsWith("_geo") || x.EndsWith("_zm") );
				filteredMap = list.ToArray();
			}
			else if (Launcher.selectedMapFilter == "MP")
			{
				var list = allMap.ToList().FindAll(x => x.StartsWith("mp_"));
				list.RemoveAll(x => x.EndsWith("_patch") || x.EndsWith("_geo"));
				filteredMap = list.ToArray();
			}
			else if (Launcher.selectedMapFilter == "nazi_zombie")
			{
				var list = allMap.ToList().FindAll(x => x.StartsWith("nazi_zombie_") || x.EndsWith("_zm") );
				list.RemoveAll(x => x.EndsWith("_patch") || x.EndsWith("_geo"));
				filteredMap = list.ToArray();
			}
			else
			...
			Array.Sort(filteredMap);
			LauncherMapList.Items.AddRange(filteredMap);
